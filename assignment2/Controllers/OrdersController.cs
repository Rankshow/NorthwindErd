...
using assignment2.NorthwinDbContext;
...
namespace assignment2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        //Implemented paging to the order index
        public async Task<IActionResult> Index(int pageNumber=1, int pageSize=5)
        {
            int ExcludeRecords = (pageSize*pageNumber) - pageNumber;

            var Orders = _context.Orders.Include(o => o.Customer).Include(o => o.ShipViaNavigation)
                .Skip(ExcludeRecords)
                .Take(pageSize);
